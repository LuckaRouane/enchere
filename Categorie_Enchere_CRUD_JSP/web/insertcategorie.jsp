        ...
        <div class="container">
            <div class="row animate-box">
                <div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
                    <h2>Insertion catégorie</h2>
                </div>
            </div>
            <div class="row animate-box">
                <div class="col-md-8 col-md-offset-2">
                    <form method="POST" action="CategorieInsert" class="form-inline">
                        <div class="col-md-6 col-sm-6">
                            <div class="form-group">
                                <label for="nom" class="sr-only">Nom de catégorie</label>
                                <input type="text" name="nom" class="form-control" id="nom" placeholder="Nom de la catégorie">
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6">
